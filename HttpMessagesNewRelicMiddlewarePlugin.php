...
class HttpMessagesNewRelicMiddlewarePlugin extends BasePlugin
{
    /**
     * Get Name
     *
    ...
    {
         return Craft::t('Http Messages - New Relic Middleware');
    }
    ...
    {
        return 'HttpMessagesNewRelicMiddleware\\Middleware\\NewRelicMiddleware';
    }
